...
set HDL_DIR "../hdl"
analyze -library $TOPLEVEL -format verilog "../hdl/Convnet_top.v"
analyze -library $TOPLEVEL -format verilog "../hdl/unshuffle.v"
analyze -library $TOPLEVEL -format verilog "../hdl/conv3.v"
